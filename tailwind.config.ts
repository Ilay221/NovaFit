    ...
    extend: {
      ...
      colors: {
        ...
        nova: {
          ...
          "surface-elevated": "hsl(var(--nova-surface-elevated))",
          success: "hsl(var(--nova-success))",
          warning: "hsl(var(--nova-warning))",
          info: "hsl(var(--nova-info))",
          protein: "hsl(var(--nova-protein))",
          carbs: "hsl(var(--nova-carbs))",
          fats: "hsl(var(--nova-fats))",
          calories: "hsl(var(--nova-calories))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
